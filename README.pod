...
The config files are read from I</etc/vfnmake.conf>, I<~/.vfnmake.conf> and I<vfnmake.conf> in that order. Additionaly there are two other files - I<vfnmake.begin> and I<vfnmake.end>. For their function see below.
